class World {
  ...
  toggleSound() {
    ...
    // Audio-Elemente stumm schalten oder aktivieren
    audioElements.forEach((audioElement) => {
      audioElement.muted = !this.audio;
      if (!this.audio) {
        audioElement.pause();
      }
    });

    // Den Boss-Sound finden und stummschalten
    const bossSound = this.boss_sound;
    bossSound.muted = !this.audio;
    if (!this.audio) {
      bossSound.pause();
    }
  }
  ...
  updateSoundIcon() {
    ...
    if (this.audio) {
      soundIcon.src = "img/icon/on-sound.png";
    } else {
      soundIcon.src = "img/icon/off-sound.png";
    }
  }
  ...
  clearIntervals() {
    ...
    this.character.clearIntervals();
    // Hier kannst du auch die Stummschaltung der Audios implementieren
  }
